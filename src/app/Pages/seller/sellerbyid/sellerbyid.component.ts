...
export class SellerbyidComponent {
  ...
  {
    this.http
      .get<Seller>('http://localhost:5254/api/Seller/GetSellerById/' + this.sellerId)
      .subscribe((response) => {
  ...
  {
    this.http
      .put('http://localhost:52547/api/Seller/EditSeller', this.seller)
      .subscribe((response) => {
        console.log(response);
      });
  ...
  delete() 
  {
    ...
    this.http
      .delete('http://localhost:5254/api/Seller/DeleteSeller/' + this.sellerId)
      .subscribe((response) => {
        console.log(response);
      });
    this.roter.navigateByUrl('getallsellers');
